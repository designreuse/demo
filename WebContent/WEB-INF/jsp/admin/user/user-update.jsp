  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form  w5c-form-validate="validateOptions" novalidate name="validateForm" class="form-horizontal  w5c-form">
        ...
        <input class="form-control" type="hidden" name="id" ng-model="obj.id" required  id="alterId">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <label class="radio-inline">
                <input type="radio"  ng-model="obj.sex" value="SECRET"> 保密
              </label>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input class="form-control" type="text" name="mobile" ng-model="obj.mobile" required ng-minlength="1" ng-maxlength="32" id="alterMobile">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <label class="radio-inline">
                <input type="radio" ng-model="obj.status"  value="NORMAL"> 正常
              </label>
              <label class="radio-inline">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input class="form-control" type="text" onkeyup="if(/\D/.test(value))value=value.replace(/\D/g,'')" name="orderby" ng-model="obj.orderby" required  id="alterOrderby">
            </div>
          </div>
